...
class ServiceSeeder extends Seeder
{
    ...
    {
        $services = [
            ['name' => 'Beachfront Access', 'description' => 'Direct access to pristine shores. Enjoy swimming, sunbathing, and stunning sunsets right at your doorstep.', 'icon' => '🏖️', 'category' => 'Amenities', 'sort_order' => 1],
            ...
            ['name' => 'Island Hopping', 'description' => 'Arrange island hopping tours to nearby islands and coves. Explore the natural beauty of the surrounding coastal areas.', 'icon' => '🚤', 'category' => 'Activities', 'sort_order' => 9],
