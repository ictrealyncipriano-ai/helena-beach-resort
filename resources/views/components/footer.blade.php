    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10 lg:gap-12">
            ...
            <div class="reveal reveal-delay-1">
                <h2 class="font-semibold text-white mb-5 text-sm uppercase tracking-wider">Quick Links</h2>
                <ul class="grid grid-cols-2 gap-x-4 gap-y-3 text-sm md:grid-cols-1 lg:grid-cols-2 md:space-y-0">
                    <li><a href="{{ route('home') }}" class="text-teal-100 hover:text-white transition-colors inline-flex items-center gap-1.5 group focus-visible:outline-2 focus-visible:outline-white focus-visible:underline"><x-icons name="chevron-right" class="w-3 h-3 text-teal-400 group-hover:translate-x-0.5 transition-transform" />Home</a></li>
                    <li><a href="{{ route('about') }}" class="text-teal-100 hover:text-white transition-colors inline-flex items-center gap-1.5 group focus-visible:outline-2 focus-visible:outline-white focus-visible:underline"><x-icons name="chevron-right" class="w-3 h-3 text-teal-400 group-hover:translate-x-0.5 transition-transform" />About</a></li>
                    <li><a href="{{ route('cottages.index') }}" class="text-teal-100 hover:text-white transition-colors inline-flex items-center gap-1.5 group focus-visible:outline-2 focus-visible:outline-white focus-visible:underline"><x-icons name="chevron-right" class="w-3 h-3 text-teal-400 group-hover:translate-x-0.5 transition-transform" />Cottages</a></li>
                    <li><a href="{{ route('gallery.index') }}" class="text-teal-100 hover:text-white transition-colors inline-flex items-center gap-1.5 group focus-visible:outline-2 focus-visible:outline-white focus-visible:underline"><x-icons name="chevron-right" class="w-3 h-3 text-teal-400 group-hover:translate-x-0.5 transition-transform" />Gallery</a></li>
                    <li><a href="{{ route('services') }}" class="text-teal-100 hover:text-white transition-colors inline-flex items-center gap-1.5 group focus-visible:outline-2 focus-visible:outline-white focus-visible:underline"><x-icons name="chevron-right" class="w-3 h-3 text-teal-400 group-hover:translate-x-0.5 transition-transform" />Services</a></li>
                    <li><a href="{{ route('news.index') }}" class="text-teal-100 hover:text-white transition-colors inline-flex items-center gap-1.5 group focus-visible:outline-2 focus-visible:outline-white focus-visible:underline"><x-icons name="chevron-right" class="w-3 h-3 text-teal-400 group-hover:translate-x-0.5 transition-transform" />News</a></li>
                    <li><a href="{{ route('faq') }}" class="text-teal-100 hover:text-white transition-colors inline-flex items-center gap-1.5 group focus-visible:outline-2 focus-visible:outline-white focus-visible:underline"><x-icons name="chevron-right" class="w-3 h-3 text-teal-400 group-hover:translate-x-0.5 transition-transform" />FAQ</a></li>
                    <li><a href="{{ route('reviews') }}" class="text-teal-100 hover:text-white transition-colors inline-flex items-center gap-1.5 group focus-visible:outline-2 focus-visible:outline-white focus-visible:underline"><x-icons name="chevron-right" class="w-3 h-3 text-teal-400 group-hover:translate-x-0.5 transition-transform" />Reviews</a></li>
                    <li><a href="{{ route('contact') }}" class="text-teal-100 hover:text-white transition-colors inline-flex items-center gap-1.5 group focus-visible:outline-2 focus-visible:outline-white focus-visible:underline"><x-icons name="chevron-right" class="w-3 h-3 text-teal-400 group-hover:translate-x-0.5 transition-transform" />Contact Us</a></li>
                </ul>
            </div>

            {{-- Contact Info --}}
            <div class="reveal reveal-delay-2">
                <h2 class="font-semibold text-white mb-5 text-sm uppercase tracking-wider">Contact Info</h2>
                <ul class="space-y-4 text-sm">
                    ...
                    <li class="flex items-start gap-3">
                        ...
                        <a href="tel:{{ $contactPhone }}" class="text-teal-100 pt-1.5 hover:text-white transition-colors">{{ $contactPhone }}</a>
                    </li>
                    @endif
                    <li class="flex items-start gap-3">
                        <span class="shrink-0 w-9 h-9 rounded-full bg-teal-800/50 flex items-center justify-center text-teal-300">
                        ...
                        <a href="mailto:{{ $site['contact_email'] }}" class="text-teal-100 pt-1.5 break-all inline-flex items-center min-h-[44px] hover:text-white transition-colors">{{ $site['contact_email'] }}</a>
                    </li>
                </ul>
            </div>
        </div>
