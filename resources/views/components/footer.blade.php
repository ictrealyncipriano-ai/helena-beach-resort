        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    ...
                    <li><a href="{{ route('services') }}" class="text-teal-200 hover:text-white transition-colors">Services</a></li>
                    <li><a href="{{ route('faq') }}" class="text-teal-200 hover:text-white transition-colors">FAQ</a></li>
                    <li><a href="{{ route('reviews') }}" class="text-teal-200 hover:text-white transition-colors">Reviews</a></li>
