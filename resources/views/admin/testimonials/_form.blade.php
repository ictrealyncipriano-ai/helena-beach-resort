<div class="space-y-5">
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div>
            ...
            <select name="rating" x-model="form.rating" required
                class="w-full px-3 py-2.5 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-300 focus:border-teal-400 transition-all bg-white dark:bg-slate-800 dark:border-slate-600 dark:text-white dark:focus:border-teal-500 dark:focus:ring-teal-500/20 @error('rating') border-red-300 dark:border-red-500 @enderror">
    ...
    <div>
        ...
        <textarea name="content" rows="4" x-model="form.content" required
            class="w-full px-3 py-2.5 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-300 focus:border-teal-400 transition-all dark:bg-slate-800 dark:border-slate-600 dark:text-white dark:placeholder-slate-400 dark:focus:border-teal-500 dark:focus:ring-teal-500/20 @error('content') border-red-300 dark:border-red-500 @enderror"></textarea>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div>
            ...
            <select name="cottage_id" x-model="form.cottage_id"
                class="w-full px-3 py-2.5 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-300 focus:border-teal-400 transition-all bg-white dark:bg-slate-800 dark:border-slate-600 dark:text-white dark:focus:border-teal-500 dark:focus:ring-teal-500/20 @error('cottage_id') border-red-300 dark:border-red-500 @enderror">
