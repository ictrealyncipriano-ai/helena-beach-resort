...
<div class="space-y-6 sm:space-y-8">
    ...
    >
        ...
        <div
            ...
            class="relative bg-white rounded-2xl shadow-sm border border-gray-100 p-5 overflow-hidden transition-all duration-300 stat-card-glow"
        >
            ...
            <div class="flex items-start justify-between mb-4">
                ...
                <span class="text-[11px] font-semibold text-teal-600 bg-teal-50/80 px-2.5 py-1 rounded-full border border-teal-100/50">Available: {{ $availableCottages }}</span>
            </div>
            <p class="text-3xl font-bold text-gray-900 tracking-tight" x-text="count"></p>
            <p class="text-sm text-gray-500 mt-1.5 font-medium">Total Cottages</p>
        </div>
        ...
        <div
            ...
            x-init="$watch('$parent.visible', v => { if(v) animate() })"
            class="relative bg-white rounded-2xl shadow-sm border border-gray-100 p-5 overflow-hidden transition-all duration-300 stat-card-amber"
        >
            ...
            <p class="text-3xl font-bold text-gray-900 tracking-tight" x-text="count"></p>
            <p class="text-sm text-gray-500 mt-1.5 font-medium">Pending Inquiries</p>
        </div>
        ...
        <div
            ...
            x-init="$watch('$parent.visible', v => { if(v) animate() })"
            class="relative bg-white rounded-2xl shadow-sm border border-gray-100 p-5 overflow-hidden transition-all duration-300 stat-card-emerald"
        >
            ...
            <p class="text-3xl font-bold text-gray-900 tracking-tight" x-text="count"></p>
            <p class="text-sm text-gray-500 mt-1.5 font-medium">Confirmed This Month</p>
            @if($revenueThisMonth)
        ...
        <div
            ...
            x-init="$watch('$parent.visible', v => { if(v) animate() })"
            class="relative bg-white rounded-2xl shadow-sm border border-gray-100 p-5 overflow-hidden transition-all duration-300 stat-card-blue"
        >
            <div class="absolute inset-x-0 top-0 h-0.5 gradient-accent-blue"></div>
            <div class="flex items-start justify-between mb-4">
                <div class="w-11 h-11 rounded-xl stat-icon-blue flex items-center justify-center shadow-sm">
                    <svg class="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0v-7.5A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5"/></svg>
                </div>
            </div>
            <p class="text-3xl font-bold text-gray-900 tracking-tight" x-text="count"></p>
            <p class="text-sm text-gray-500 mt-1.5 font-medium">Upcoming Check-Ins</p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
                ...
                <a href="{{ route('admin.inquiries.index') }}" class="text-xs font-medium text-teal-600 hover:text-teal-700 transition-colors flex items-center gap-1">
                    View all
                    ...
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="text-xs text-gray-500 uppercase tracking-wider">
                                <th class="text-left px-5 py-3 font-medium bg-gray-50/50">Ref #</th>
                                <th class="text-left px-5 py-3 font-medium bg-gray-50/50">Guest</th>
                                <th class="text-left px-5 py-3 font-medium bg-gray-50/50">Cottage</th>
                                <th class="text-left px-5 py-3 font-medium bg-gray-50/50">Check In</th>
                                <th class="text-left px-5 py-3 font-medium bg-gray-50/50">Check Out</th>
                                <th class="text-center px-5 py-3 font-medium bg-gray-50/50">Pax</th>
                                <th class="text-left px-5 py-3 font-medium bg-gray-50/50">Type</th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-gray-50">
                            @foreach($upcomingCheckIns as $inquiry)
                            <tr class="hover:bg-gray-50/50 transition-colors">
                                <td class="px-5 py-3.5 text-gray-500 font-mono text-xs font-medium">{{ $inquiry->reference_code }}</td>
                                <td class="px-5 py-3.5 font-medium text-gray-900">{{ $inquiry->name }}</td>
                                <td class="px-5 py-3.5">@include('admin.components.badge', ['type' => 'primary', 'slot' => $inquiry->cottage?->name ?? 'N/A'])</td>
                                <td class="px-5 py-3.5 text-gray-600">{{ $inquiry->check_in?->format('M d, Y') ?? '—' }}</td>
                                <td class="px-5 py-3.5 text-gray-600">{{ $inquiry->check_out?->format('M d, Y') ?? '—' }}</td>
                                <td class="px-5 py-3.5 text-center text-gray-600">{{ $inquiry->pax ?? '—' }}</td>
                ...
                <div class="mobile-table-cards p-4 space-y-3">
                    ...
                    <div class="mobile-table-card">
                        ...
                        <div class="flex items-center justify-between pt-1">
                            <span class="text-xs text-gray-500">{{ $inquiry->pax ?? '—' }} guest(s)</span>
            ...
            @else
                ...
                <div class="desktop-table overflow-x-auto">
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="text-xs text-gray-500 uppercase tracking-wider">
                                <th class="text-left px-5 py-3 font-medium bg-gray-50/50">Name</th>
                                <th class="text-left px-5 py-3 font-medium bg-gray-50/50">Email</th>
                                <th class="text-left px-5 py-3 font-medium bg-gray-50/50">Cottage</th>
                                <th class="text-left px-5 py-3 font-medium bg-gray-50/50">Status</th>
                                <th class="text-left px-5 py-3 font-medium bg-gray-50/50">Date</th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-gray-50">
                            ...
                            <tr class="hover:bg-gray-50/50 transition-colors">
                                <td class="px-5 py-3.5 font-medium text-gray-900">{{ $inquiry->name }}</td>
                                <td class="px-5 py-3.5 text-gray-500">{{ $inquiry->email }}</td>
                                <td class="px-5 py-3.5">@include('admin.components.badge', ['type' => 'primary', 'slot' => $inquiry->cottage?->name ?? 'N/A'])</td>
                                ...
                                <td class="px-5 py-3.5 text-gray-500 text-xs">{{ $inquiry->created_at->format('M d, Y H:i') }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
                ...
                <div class="mobile-table-cards p-4 space-y-3">
                    ...
                    <div class="mobile-table-card">
                        ...
                        <div class="field">
                            ...
                            <span class="field-value text-gray-500 text-xs">{{ $inquiry->email }}</span>
                        </div>
                        <div class="field">
                        ...
                        <div class="field">
                            ...
                            <span class="field-value text-xs text-gray-500">{{ $inquiry->created_at->format('M d, Y H:i') }}</span>
                        </div>
                    </div>
                    @endforeach
                </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5">
            <div class="flex items-center justify-between mb-4">
                ...
                <span class="text-xs text-gray-500 font-medium">₱ {{ number_format($revenueData->sum(), 2) }} total</span>
            </div>
                        ...
                        data: {
                            ...
                            datasets: [{
                                ...
                                backgroundColor: function(ctx) {
                                    ...
                                    g.addColorStop(0, 'rgba(13,148,136,0.25)');
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
            ...
            @if($popularCottages->isNotEmpty())
                <span class="text-xs text-gray-500 font-medium">{{ $popularCottages->count() }} cottages</span>
            @endif
        </div>
            ...
            <div class="desktop-table overflow-x-auto">
                <table class="w-full text-sm">
                    <thead>
                        <tr class="text-xs text-gray-500 uppercase tracking-wider">
                            <th class="text-left px-5 py-3 font-medium bg-gray-50/50">Cottage</th>
                            <th class="text-center px-5 py-3 font-medium bg-gray-50/50">Bookings</th>
                            <th class="text-left px-5 py-3 font-medium bg-gray-50/50">Popularity</th>
                            <th class="text-center px-5 py-3 font-medium bg-gray-50/50">Max Pax</th>
                            <th class="text-right px-5 py-3 font-medium bg-gray-50/50">Day Tour</th>
                            <th class="text-right px-5 py-3 font-medium bg-gray-50/50">Overnight</th>
                            <th class="text-center px-5 py-3 font-medium bg-gray-50/50">Available</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-50">
                        ...
                        @endphp
                        <tr class="hover:bg-gray-50/50 transition-colors">
                            <td class="px-5 py-3.5 font-medium text-gray-900">{{ $cottage->name }}</td>
                            <td class="px-5 py-3.5 text-center">
                                <span class="inline-flex items-center justify-center w-7 h-7 rounded-full bg-teal-50 text-teal-700 text-xs font-bold">{{ $cottage->inquiries_count }}</span>
                            </td>
                            <td class="px-5 py-3.5">
                                <div class="flex items-center gap-3">
                                    ...
                                    <span class="text-xs text-gray-400 font-medium w-8">{{ $pct }}%</span>
                                </div>
                            </td>
                            <td class="px-5 py-3.5 text-center text-gray-600">{{ $cottage->capacity }}</td>
                            <td class="px-5 py-3.5 text-right text-gray-600 font-medium">₱ {{ number_format($cottage->rate_daytour, 2) }}</td>
                            <td class="px-5 py-3.5 text-right text-gray-600 font-medium">₱ {{ number_format($cottage->rate_overnight, 2) }}</td>
                            <td class="px-5 py-3.5 text-center">
            ...
            <div class="mobile-table-cards p-4">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    <div class="bg-gray-50/50 rounded-xl p-4 border border-gray-100 space-y-3">
                        <div class="flex items-center justify-between">
                            <span class="font-semibold text-gray-900">{{ $cottage->name }}</span>
                            @if($cottage->is_available)
                        ...
                        <div class="flex items-center justify-between text-sm">
                            ...
                            <span class="inline-flex items-center justify-center w-6 h-6 rounded-full bg-teal-50 text-teal-700 text-xs font-bold">{{ $cottage->inquiries_count }}</span>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-2 text-xs">
                            <div>
                                <span class="text-gray-400">Day Tour</span>
                                <p class="font-medium text-gray-700">₱ {{ number_format($cottage->rate_daytour, 2) }}</p>
                            </div>
                            <div>
                                <span class="text-gray-400">Overnight</span>
                                <p class="font-medium text-gray-700">₱ {{ number_format($cottage->rate_overnight, 2) }}</p>
                            </div>
                            <div>
                                <span class="text-gray-400">Max Pax</span>
                                <p class="font-medium text-gray-700">{{ $cottage->capacity }}</p>
                            </div>
                            <div>
                                <span class="text-gray-400">Popularity</span>
                                <p class="font-medium text-gray-700">{{ $pct }}%</p>
                            </div>
                        </div>
                    </div>
                    @endforeach
