        ...
        <div class="p-4 sm:p-5 border-b border-gray-100 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 dark:border-slate-700">
            ...
            <div class="flex items-center gap-2">
                <form action="{{ route('admin.faqs.activate-all') }}" method="POST" class="inline">
                    @csrf
                    <button type="submit" class="px-3 py-2 text-sm font-medium text-teal-700 bg-teal-50 border border-teal-200 rounded-lg hover:bg-teal-100 transition-colors dark:bg-teal-900/30 dark:text-teal-300 dark:border-teal-800 dark:hover:bg-teal-900/50" onclick="return confirm('Activate all FAQs?')">Activate All</button>
                </form>
