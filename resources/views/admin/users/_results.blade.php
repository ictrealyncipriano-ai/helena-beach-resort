    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div class="relative bg-white rounded-2xl shadow-sm border border-gray-100 p-4 sm:p-5 overflow-hidden">
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-2xl font-bold text-gray-900 tracking-tight" x-text="filteredUsers.length"></p>
        ...
        <div class="relative bg-white rounded-2xl shadow-sm border border-gray-100 p-4 sm:p-5 overflow-hidden">
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-2xl font-bold text-gray-900 tracking-tight" x-text="adminCount"></p>
        ...
        <div class="relative bg-white rounded-2xl shadow-sm border border-gray-100 p-4 sm:p-5 overflow-hidden">
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-2xl font-bold text-gray-900 tracking-tight" x-text="staffCount"></p>
        ...
        <div class="p-4 sm:p-5 border-b border-gray-100 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <form method="GET" class="flex gap-3 flex-1 max-w-md">
                <div class="relative flex-1">
                    ...
                    <input type="text" name="search" x-model="search" value="{{ request('search') }}" placeholder="Search users..." class="w-full pl-9 pr-3 py-2 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-300 focus:border-teal-400 transition-all">
                </div>
                ...
                <tbody class="divide-y divide-gray-50">
                    <template x-for="user in filteredUsers" :key="user.id">
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-5 py-3 text-gray-500" x-text="user.email"></td>
                            <td class="px-5 py-3">
                            ...
                            <td class="px-5 py-3 text-gray-500" x-text="user.joined"></td>
                            <td class="px-5 py-3 text-right">
                                <div class="flex items-center justify-end gap-1">
                                    <button type="button" @@click="openEdit(user)" class="p-1.5 text-gray-400 hover:text-teal-600 hover:bg-teal-50 rounded-lg transition-colors" title="Edit">
                ...
                <div class="p-4 space-y-3">
                    <div class="flex items-center gap-3">
                        ...
                        <div class="flex items-center gap-1">
                            <button type="button" @@click="openEdit(user)" class="p-2 text-gray-400 hover:text-teal-600 hover:bg-teal-50 rounded-lg transition-colors">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10"/></svg>
                            </button>
                            <template x-if="user.id !== authId">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-xs text-gray-400" x-text="user.joined"></span>
                    </div>
                </div>
            </template>
        </div>
