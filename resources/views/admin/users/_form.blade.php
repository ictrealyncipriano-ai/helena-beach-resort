<div class="space-y-6">
    ...
    <div class="space-y-5">
        <div>
            <label class="block text-sm font-medium text-gray-700 mb-1.5 dark:text-slate-200">Full Name <span class="text-red-500">*</span></label>
        ...
        <div>
            <label class="block text-sm font-medium text-gray-700 mb-1.5 dark:text-slate-200">Email Address <span class="text-red-500">*</span></label>
        ...
        <div>
            <label class="block text-sm font-medium text-gray-700 mb-1.5 dark:text-slate-200">
                Password <template x-if="!isEditing"><span class="text-red-500">*</span></template>
                <template x-if="isEditing"><span class="text-gray-400 font-normal dark:text-slate-500">(leave blank to keep current)</span></template>
            </label>
            <input type="password" name="password" x-model="form.password" minlength="8" :required="!isEditing"
                class="w-full px-3 py-2.5 text-sm border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-300 focus:border-teal-400 transition-all @error('password') border-red-300 @enderror dark:bg-slate-800 dark:border-slate-600 dark:text-white dark:placeholder-slate-400 dark:focus:border-teal-500 dark:focus:ring-teal-500/20">
            ...
            <template x-if="!isEditing">
                <div>
                    ...
                    <p class="mt-1 text-xs text-gray-400 dark:text-slate-500">Min 8 characters. Longer passwords are stronger.</p>
                </div>
            </template>
        </div>
    </div>
    ...
    {{-- Role Selection --}}
    <div>
        <h4 class="text-sm font-semibold text-gray-900 mb-3 dark:text-white">Role & Permissions</h4>
                ...
                <div class="rounded-xl border-2 p-4 transition-all duration-200 peer-checked:border-teal-500 peer-checked:bg-teal-50/50 border-gray-200 hover:border-gray-300 bg-white dark:border-slate-600 dark:hover:border-slate-500 dark:bg-slate-800 dark:peer-checked:bg-teal-500/10">
                    <div class="flex items-center gap-3 mb-2">
                        <div class="w-9 h-9 rounded-full bg-teal-100 flex items-center justify-center dark:bg-teal-500/10">
                            <svg class="w-4 h-4 text-teal-600 dark:text-teal-300" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z"/></svg>
                        </div>
