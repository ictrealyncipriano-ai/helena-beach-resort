...
<div x-data="siteSettingModal()" class="space-y-6">
    <div class="bg-teal-50 border border-teal-200 rounded-xl px-5 py-4 text-sm text-teal-800 leading-relaxed dark:bg-teal-900/30 dark:border-teal-800 dark:text-teal-200">
        ...
        <p><span class="font-mono text-xs">site_logo</span> / <span class="font-mono text-xs">site_favicon</span> take a Storage path (e.g. <span class="font-mono text-xs">logos/sunset.png</span>); empty falls back to shipped files. <span class="font-mono text-xs">theme_color</span> is a hex code. <span class="font-mono text-xs">geo_region</span>, <span class="font-mono text-xs">geo_placename</span> and <span class="font-mono text-xs">address_locality|region|country</span> drive maps and structured data. <span class="font-mono text-xs">booking_cutoff_hours</span> (1–168, default 24) and <span class="font-mono text-xs">booking_hold_hours</span> (1–168, default 48) govern modification windows and pending-request expiry; invalid values safely fall back. <span class="font-mono text-xs">about_body</span> (sanitized HTML), <span class="font-mono text-xs">footer_tagline</span> and <span class="font-mono text-xs">operating_hours</span> drive the About page, footer, and contact info. <span class="font-mono text-xs">og_image</span> sets the social share image (empty falls back to the logo).</p>
    </div>
