...
@section('breadcrumb')
    <x-admin.breadcrumb :items="[['label' => 'Inquiries', 'url' => route('admin.inquiries.index')], ['label' => $inquiry->reference_code]]" />
@endsection
...
<x-admin.confirm-dialog name="refund" title="Refund Payment?" message="Refund the collected amount (" confirmText="Refund & Cancel" confirmClass="bg-red-600 hover:bg-red-700 text-white" />
@endsection