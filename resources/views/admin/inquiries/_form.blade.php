    ...
    <div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="number" step="0.01" name="deposit_amount" id="deposit-amount-field" x-model="form.deposit_amount" min="0" :max="form.total_amount || null"
                ...
                <p class="mt-1 text-xs text-gray-500 dark:text-slate-400">Guest pays this first online, then the balance. Cannot exceed the total.</p>
            </div>
            <div>
