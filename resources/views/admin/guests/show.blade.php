        ...
        @if($guest->inquiries->isNotEmpty())
            <div class="px-5 pb-5 pt-4 border-t border-gray-100 grid grid-cols-2 sm:grid-cols-4 gap-4 dark:border-slate-700">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm font-semibold text-gray-900 dark:text-white">₱ {{ number_format($paidAmount, 2) }}</p>
                </div>
                <div>
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y divide-gray-50 dark:divide-slate-700/50">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors dark:hover:bg-slate-700/40">
                            ...
                            <td class="px-5 py-3 text-right font-medium dark:text-white">₱ {{ number_format($inquiry->total_amount, 2) }}</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
