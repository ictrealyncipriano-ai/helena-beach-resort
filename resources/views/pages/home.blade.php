...
<section class="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
    ...
    <div class="relative z-10 text-center px-4 max-w-5xl mx-auto">
        ...
        {{-- Availability Widget --}}
        @if($widgetCottages->isNotEmpty())
        <div class="mt-12 max-w-3xl mx-auto" x-data="availabilityWidget()" x-init="initWidget()">
            <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl shadow-teal-900/20 p-6 sm:p-8 text-left">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 items-end">
                    <div>
                        ...
                        <select id="widget-cottage" x-model="cottageId" @change="onCottageChange()"
                            class="w-full px-3 py-2.5 text-sm border border-gray-200 dark:bg-slate-800 dark:border-slate-600 dark:text-white rounded-lg focus:ring-2 focus:ring-teal-600 focus:border-teal-500 outline-none transition-colors">
                            <option value="">Choose a cottage</option>
                            @foreach($widgetCottages as $cottage)
                    ...
                    <div>
                        ...
                        <input type="text" id="widget-check-in" readonly x-ref="checkIn" x-model="checkIn"
                            ...
                            class="w-full px-3 py-2.5 text-sm border border-gray-200 dark:bg-slate-800 dark:border-slate-600 dark:text-white rounded-lg focus:ring-2 focus:ring-teal-600 focus:border-teal-500 outline-none transition-colors cursor-pointer">
                    </div>
                    ...
                    <div class="sm:col-span-3">
                        <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 px-4 py-3 rounded-xl bg-teal-50 dark:bg-teal-900/30">
