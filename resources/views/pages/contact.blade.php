        ...
        <div class="grid grid-cols-1 lg:grid-cols-5 gap-12">
            ...
            <div class="lg:col-span-3 reveal">
                <form method="POST" action="{{ route('contact.store') }}" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name') }}" required
                                class="w-full px-4 py-2.5 border border-gray-300 dark:bg-slate-800 dark:border-slate-600 dark:text-white dark:placeholder-slate-400 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-teal-500 dark:focus:border-teal-500 dark:ring-teal-500/20 outline-none transition-all text-sm @error('name') border-red-400 @enderror">
                        ...
                        <div>
                            ...
                            <input type="email" id="email" name="email" value="{{ old('email') }}" required
                                class="w-full px-4 py-2.5 border border-gray-300 dark:bg-slate-800 dark:border-slate-600 dark:text-white dark:placeholder-slate-400 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-teal-500 dark:focus:border-teal-500 dark:ring-teal-500/20 outline-none transition-all text-sm @error('email') border-red-400 @enderror">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="tel" id="phone" name="phone" value="{{ old('phone') }}"
                                class="w-full px-4 py-2.5 border border-gray-300 dark:bg-slate-800 dark:border-slate-600 dark:text-white dark:placeholder-slate-400 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-teal-500 dark:focus:border-teal-500 dark:ring-teal-500/20 outline-none transition-all text-sm">
                        </div>
                        <div>
                    ...
                    <div>
                        <label for="message" class="block text-sm font-medium text-gray-700 dark:text-slate-200 mb-1">Message <span class="text-red-500">*</span></label>
                        <textarea id="message" name="message" rows="5" required
                            class="w-full px-4 py-2.5 border border-gray-300 dark:bg-slate-800 dark:border-slate-600 dark:text-white dark:placeholder-slate-400 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-teal-500 dark:focus:border-teal-500 dark:ring-teal-500/20 outline-none transition-all text-sm @error('message') border-red-400 @enderror">{{ old('message') }}</textarea>
                        @error('message') <p class="text-xs text-red-500 mt-1">{{ $message }}</p> @enderror
                    </div>

                    <button type="submit" class="w-full sm:w-auto px-8 py-3 bg-teal-600 text-white font-medium rounded-full hover:bg-teal-700 transition-all hover:shadow-lg hover:shadow-teal-600/20 active:scale-95 inline-flex items-center gap-2">
            ...
            <div class="lg:col-span-2 space-y-6 reveal reveal-delay-1">
                <div class="bg-gradient-to-br from-teal-50 to-teal-50/50 dark:from-teal-900/30 dark:to-teal-900/20 rounded-2xl p-6 border border-teal-100/50 dark:border-teal-900/30">
                    <div class="flex items-center gap-3 mb-4">
                        <div class="w-10 h-10 bg-teal-100 dark:bg-teal-900/40 rounded-xl flex items-center justify-center text-teal-600 dark:text-teal-300">
                ...
                <div class="bg-gradient-to-br from-teal-50 to-teal-50/50 dark:from-teal-900/30 dark:to-teal-900/20 rounded-2xl p-6 border border-teal-100/50 dark:border-teal-900/30">
                    ...
                    <p class="text-sm text-gray-600 dark:text-slate-300">Contact number available upon request</p>
                </div>
                ...
                <div class="bg-gradient-to-br from-teal-50 to-teal-50/50 dark:from-teal-900/30 dark:to-teal-900/20 rounded-2xl p-6 border border-teal-100/50 dark:border-teal-900/30">
                    ...
                    <div class="space-y-1 text-sm text-gray-600 dark:text-slate-300">
                        ...
                        <p class="text-xs text-gray-400 dark:text-slate-500 mt-2">Overnight stays available upon reservation</p>
                    </div>
                </div>
            </div>
        </div>
