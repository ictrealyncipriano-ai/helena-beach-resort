...
<article class="py-16 sm:py-20 bg-white dark:bg-slate-800">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        @if($post->cover_image)
        <img src="{{ Storage::url($post->cover_image) }}" alt="{{ $post->title }}" width="768" height="432" fetchpriority="high" decoding="async" class="w-full aspect-[16/9] object-cover rounded-2xl border border-gray-100 dark:border-slate-700 shadow-sm mb-10">
        @endif
