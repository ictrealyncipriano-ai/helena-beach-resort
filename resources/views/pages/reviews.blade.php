...
<section class="py-20 sm:py-28 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 sm:p-8 flex flex-col hover:shadow-lg hover:border-teal-100 transition-all duration-300 reveal {{ $i > 0 ? 'reveal-delay-' . min($i % 3 + 1, 4) : '' }}">
