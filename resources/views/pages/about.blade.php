...
<section class="py-20 sm:py-28 bg-white dark:bg-slate-800">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center mb-20 reveal">
            <div>
                <span class="inline-block text-xs font-semibold tracking-widest uppercase text-teal-600 dark:text-teal-300 mb-3">Our Story</span>
        ...
        <div class="mb-20 reveal">
            <div class="text-center mb-10">
                <span class="inline-block text-xs font-semibold tracking-widest uppercase text-teal-600 dark:text-teal-300 mb-3">Location</span>
                <h2 class="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white mb-4 font-heading">Find Us</h2>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 reveal">
            <div class="bg-gradient-to-br from-teal-50 to-teal-50/50 dark:from-teal-900/30 dark:to-teal-900/20 rounded-2xl p-8 text-center border border-teal-100/50 dark:border-teal-900/30 hover:shadow-md transition-shadow">
                <div class="w-12 h-12 bg-teal-100 dark:bg-teal-900/40 rounded-xl flex items-center justify-center mx-auto mb-4 text-teal-600 dark:text-teal-300">
            ...
            <div class="bg-gradient-to-br from-teal-50 to-teal-50/50 dark:from-teal-900/30 dark:to-teal-900/20 rounded-2xl p-8 text-center border border-teal-100/50 dark:border-teal-900/30 hover:shadow-md transition-shadow">
                ...
                <p class="text-xs text-gray-400 dark:text-slate-500 mt-1">Overnight stays available upon reservation</p>
            </div>
            <div class="bg-gradient-to-br from-teal-50 to-teal-50/50 dark:from-teal-900/30 dark:to-teal-900/20 rounded-2xl p-8 text-center border border-teal-100/50 dark:border-teal-900/30 hover:shadow-md transition-shadow">
                <div class="w-12 h-12 bg-teal-100 dark:bg-teal-900/40 rounded-xl flex items-center justify-center mx-auto mb-4 text-teal-600 dark:text-teal-300">
                ...
                <p class="text-sm text-gray-600 dark:text-slate-300 leading-relaxed">Contact number available upon request</p>
                <a href="{{ route('contact') }}" class="inline-block mt-3 text-sm font-medium text-teal-600 dark:text-teal-300 hover:text-teal-700 dark:hover:text-teal-200 group">
                    Send us a message
