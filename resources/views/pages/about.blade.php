    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-20 reveal">
            <div class="text-center mb-10">
                <span class="inline-block text-xs font-semibold tracking-widest uppercase text-teal-700 dark:text-teal-300 mb-3">Location</span>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 reveal">
            ...
            <div class="bg-gradient-to-br from-teal-50 to-teal-50/50 dark:from-teal-900/30 dark:to-teal-900/20 rounded-2xl p-8 text-center border border-teal-100/50 dark:border-teal-900/30 hover:shadow-md transition-shadow">
                ...
                @endif
                <a href="{{ route('contact') }}" class="inline-block mt-3 text-sm font-medium text-teal-700 dark:text-teal-300 hover:text-teal-700 dark:hover:text-teal-200 group">
                    Send us a message
